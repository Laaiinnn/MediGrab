...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/medlogo.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="pharmacy.php">Pharmacies <span class="sr-only"></span></a> </li>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/pills.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & PickUp </h1>
                    <h5 class="font-white space-xs">Find Pharmacies</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='pharmacy.html'" type="button" class="btn theme-btn btn-lg">Search medicine</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Pharmacy</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Medicine</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Delivery or PickUp</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Medicines of the Month</h2>
                    <p class="lead">The easiest way to your needs</p>
                </div>
                <div class="row">
						...
						<?php 
						// fetch records from database to display popular first 3 medicine from table
						$query_res= mysqli_query($db,"select * from meds LIMIT 3"); 
									      while($r=mysqli_fetch_array($query_res))
										  {
													
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="admin/Res_img/meds/'.$r['img'].'">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with products from over 50 delivery pharmacy online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a medicine for your needs</h3>
                                <p>We"ve got your covered with products from over 50 delivery pharmacy online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your medicine delivered! And be safe and healthy! Pay online on pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Featured pharmacy starts -->
        <section class="featured-restaurants">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured Pharmacies</h4> </div>
                    </div>
                    <div class="col-sm-8">
                        <!-- pharmacy filter nav starts -->
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
									...
									$res= mysqli_query($db,"select * from ph_category");
                        ...
                        <!-- pharmacy filter nav ends -->
                    </div>
                </div>
                <!-- pharmacy listing starts -->
                <div class="row">
                    <div class="restaurant-listing">
                        
						
						<?php  //fetching records from table and filter using html data-filter tag
						$ress= mysqli_query($db,"select * from pharmacy");  
									      while($rows=mysqli_fetch_array($ress))
										  {
													// fetch records from ph_category table according to catgory ID
													$query= mysqli_query($db,"select * from ph_category where c_id='".$rows['c_id']."' ");
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="medicine.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
																<!--end:col -->
                ...
                <!-- pharmacy listing ends -->
               
            </div>
        </section>
        <!-- Featured pharmacy ends -->
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            <div class="col-xs-12 col-sm-5 right-image text-center">
                                <figure> <img src="images/apps.png" alt="Right Image" class="img-fluid"> </figure>
                            </div>
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>The Best Medicine Delivery App</h3>
                                <p>Now you can make Medicine happen pretty much wherever you are thanks to the free easy-to-use Medicine Delivery &amp; PickUp App.</p>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/medlogo.png" alt="Footer logo"> </a> <span>Order Delivery &amp; PickUp </span> </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Concept design of oline medicine order and deliveye,planned as pharmacy directory</p>
                            <h5>Phone: <a href="tel:+080000012222">080 000012 222</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>Join the thousands of other pharmacy who benefit from having their products on TakeOff</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
